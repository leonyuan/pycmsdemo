		...
		if ($(this).length && showAddButton) {
			...
			addButton.click(function() {
				...
				if (row.is("tr")) {
					...
					row.children(":first").children(":first").children(":first").append('<span style="float:right"><a class="' + options.deleteCssClass + '" href="javascript:void(0)">' + options.deleteText + "</a></span>");
				}
